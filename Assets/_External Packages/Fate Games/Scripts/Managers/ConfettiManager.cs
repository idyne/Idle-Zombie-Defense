...
namespace FateGames
{
    public static class ConfettiManager
    {
        ...
        {
            Transform confetti = ObjectPooler.SpawnFromPool("Confetti Blast", position, Quaternion.Euler(rotation)).transform;
        ...
        {
            Transform confetti = ObjectPooler.SpawnFromPool("Confetti Directional", position, Quaternion.Euler(rotation)).transform;
            confetti.localScale = scale;
            return confetti;
        }
    }
