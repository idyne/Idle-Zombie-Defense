...
public static class Settings
{
    ...
    public static int SoldierMergeLevelCost { get => Mathf.CeilToInt((CycleNumber > 1 ? 2 : 1) * ((PlayerData.SoldierMergeLevel - 1) * 5 + 15)); }
    ...
    public static int BarbwireDPS { get => Mathf.CeilToInt(PlayerData.BarbwireLevel * (CycleNumber > 1 ? 4 : 10) * (WorldDay / 3 + 1)); }
    public static int TNTDamage { get => Mathf.CeilToInt(PlayerData.TNTLevel * (CycleNumber > 1 ? 8 : 15) * (WorldDay / 3 + 1)); }
    public static int FrostDuration { get => Mathf.CeilToInt(PlayerData.FrostLevel * (CycleNumber > 1 ? 2 : 10)); }
    ...
    public static class World1
    {
        ...
        public static int FinishDayUpgradePrize
        {
            get
            {
                ...
                if (Day == 4 || Day == 8)
                    money = 10;
                return Mathf.CeilToInt(money * (CycleNumber > 1 ? 2 : 1));
            }
        }
        ...
        {
            int bossMultiplier = CycleNumber > 1 ? 4 : 5;
        ...
        private static readonly int BaseZombieDamage = CycleNumber > 1 ? 150 : 30;
        ...
        #endregion
        #region Turret
        public static int TurretDamage { get => Mathf.CeilToInt(PlayerData.TurretLevel * (CycleNumber > 1 ? 3 : 50) * (WorldDay / 3f + 1)); }
        #endregion
        #region Commander
        ...
        public static int MolotovDPS { get => Mathf.CeilToInt(CycleNumber > 1 ? 20 : 50 * (WorldDay / 3f + 1)); }
        #endregion
        #region Airstrike
        public static int AirstrikeDamage { get => Mathf.CeilToInt(PlayerData.AirstrikeLevel * (CycleNumber > 1 ? 6 : 20) * (WorldDay / 3f + 1)); }
        #endregion
    }
    ...
    public static class World2
    {
        ...
        private static readonly float BaseZombieHealth = CycleNumber > 1 ? 1600 : 200f;
        ...
        public static int ZombieHealth(int level, bool boss)
        {
            int bossMultiplier = CycleNumber > 1 ? 8 : 10;
            /*if (WorldDay >= 3)
                WorldDayMultiplier *= 0.5f;*/
            float result = level * (BaseZombieHealth * Mathf.Pow(1 + ZombieHealthExponentialIncreaseRatio, WorldDay - 1) + (WorldDay - 1) * ZombieHealthLinearIncreaseRatio);
        ...
        private static readonly int BaseZombieDamage = CycleNumber > 1 ? 750 : 150;
        ...
        public static int TurretDamage { get => Mathf.CeilToInt(PlayerData.TurretLevel * (CycleNumber > 1 ? 6 : 20) * (WorldDay / 3f + 1)); }
        #endregion
        #region Commander

        public static readonly float BaseCommanderWeaponDamage = CycleNumber > 1 ? 241 : 80;
        ...
        public static int CommanderWeaponDamage { get => Mathf.CeilToInt(BaseCommanderWeaponDamage * Mathf.Pow(1 + CommanderWeaponDamageExponentialIncreaseRatio, WorldDay - 1) + (WorldDay - 1) * CommanderWeaponDamageLinearIncreaseRatio); }
        public static int GrenadeDamage { get => Mathf.CeilToInt(35 * (WorldDay / 3f + 1)); }
        public static int MolotovDPS { get => Mathf.CeilToInt(CycleNumber > 1 ? 29 : 70 * (WorldDay / 3f + 1)); }

        #endregion
        #region Airstrike

        public static int AirstrikeDamage { get => Mathf.CeilToInt(PlayerData.AirstrikeLevel * (CycleNumber > 1 ? 9 : 30) * (WorldDay / 3f + 1)); }
        #endregion
    }
